    ...
    return (
        <>
            <Header 
                ...
                backgroundImage="src/assets/img/basketball-bg.jpg"
                    ...
                    <div className="row gx-4 gx-lg-5 justify-content-center">
                        <div className="col-md-10 col-lg-8 col-xl-7">
                            ...
                            <div className="container text-center">
                                <div className="row align-items-start">
                                    <div className="col">
                                        <PostImage image_path="/src/assets/img/western-conference.png" />
                                    </div>
                                    <div className="col">
                                        <PostImage image_path="/src/assets/img/eastern-conference.png" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <PostImage image_path="/src/assets/img/nba-playoff.jpg" />
                            <p>
